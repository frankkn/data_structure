    ...
    for i in range(1, len(s)):
      ...
      while j < len(s):
        if s[j] in cur.out:
          ...
          # Fell off edge at a node: make new edge hanging off it
...
if __name__ == '__main__':
  ...
  print(stree.hasSubstring('nope')) # output: False
  print(stree.hasSubstring('would have been')) # output: True
  print(stree.hasSubstring('such a word')) # output: True
  print(stree.hasSuffix('would have been')) # output: False
  print(stree.hasSuffix('such a word')) # output: True